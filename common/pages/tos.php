			...
			<div>
				...
				<ol>
					<li>
						...
						(information or software) on <?=$setting["url"]?>'s web site for personal,
						non-commercial transitory viewing only. This is the grant of a license,
						not a transfer of title, and under this license you may not:
						<ol>
							<li><del>modify</del> or copy the materials;</li>
							<li>use the materials for any commercial purpose, <del>or for any public display</del> (commercial or <del>non-commercial<del>);</li>
								<li>attempt to decompile or reverse engineer any software contained on <?=$setting["url"]?>'s web site;</li>
						...
						<li>
							...
							restrictions and may be terminated by <?=$setting["url"]?> at any time. Upon
					...
					<ol>
						<li>
							The materials on <?=$setting["url"]?>'s web site are provided "as is".
							<?=$setting["url"]?> makes no warranties, expressed or implied, and hereby
							disclaims and negates all other warranties, including without
							limitation, implied warranties or conditions of merchantability, fitness
							for a particular purpose, or non-infringement of intellectual property
							or other violation of rights. Further, <?=$setting["url"]?> does not warrant
					...
					<h3>4. Limitations</h3>
					<p>
						In no event shall <?=$setting["url"]?> or its suppliers be liable for any
						damages (including, without limitation, damages for loss of data or
						profit, or due to business interruption,) arising out of the use or
						inability to use the materials on <?=$setting["url"]?>'s Internet site, even
						if <?=$setting["url"]?> or a <?=$setting["url"]?> authorized representative has been
					...
					<p>
						The materials appearing on <?=$setting["url"]?>'s web site could include
						technical, typographical, or photographic errors. <?=$setting["url"]?> does
						not warrant that any of the materials on its web site are accurate,
						complete, or current. <?=$setting["url"]?> may make changes to the materials
						contained on its web site at any time without notice. <?=$setting["url"]?>
						does not, however, make any commitment to update the materials.
					</p>
					<h3>6. Links</h3>
					<p>
						<?=$setting["url"]?> has not reviewed all of the sites linked to its Internet
						web site and is not responsible for the contents of any such linked
						site. The inclusion of any link does not imply endorsement by
						<?=$setting["url"]?> of the site. Use of any such linked web site is at the
						user's own risk.
					</p>
					<h3>7. Site Terms of Use Modifications</h3>
					<p>
						<?=$setting["url"]?> may revise these terms of use for its web site at any
					...
					<p>
						Any claim relating to <?=$setting["url"]?>'s web site shall be governed by
						the laws of the State of Arkansas without regard to its conflict of law
						provisions.
					</p>
					<p>
