...
$paypal['site_url'] = $setting["store_url"];

$paypal[image_url]="";

$paypal['return'] = $setting["store_url"]."/paypal/success.php";

$paypal['cancel_return'] = $setting["store_url"]."/paypal/cancelled.php";

$paypal['notify_url'] = $setting["store_url"]."/paypal/ipn.php";
...
if(isset($_POST['carts'])) {
	...
	$paypal['shopping_url'] = $setting["store_url"];
